...
# Bot settings
DELETE_TIME = int(environ.get('DELETE_TIME', 604800)) # Add time in seconds
...
PM_FILE_DELETE_TIME = int(environ.get('PM_FILE_DELETE_TIME', '604800'))
...
OWNER_UPI_ID = environ.get('OWNER_UPI_ID', 'chethmina')
